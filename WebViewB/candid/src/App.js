...
function App() {
  return (
    <div className="body">
     ...
     <div className="rect1"><div className="heart"></div><div className="heart-num">7</div></div>
     <div className="rect2"><div className="heart"></div><div className="heart-num">8</div></div>
